...
<head>
  ...
  <link href="<?= BASE  ?>/front_assets/assets/css/pages/login/classic/login-6.css" rel="stylesheet" type="text/css" />
  ...
  <!--end::Layout Themes-->
  <link rel="shortcut icon" href="<?= BASE  ?>/front_assets/custom/apps/ecommerce/img/logo2.png" />

</head>
<!--end::Head-->
<!--begin::Body-->

<body id="kt_body" style="background-image: url(<?= BASE  ?>/front_assets/assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
  ...
  <script src="<?= BASE  ?>/front_assets/assets/js/pages/custom/login/login-general.js"></script>
  <!--end::Page Scripts-->
</body>
<!--end::Body-->
