  ...
  <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-content pr-5 mr-n5">
      ...
      <div class="navi navi-spacer-x-0 p-0">
        ...
        <a href="<?= BASE ?>/front/dikembalikan" class="navi-item">
          <div class="navi-link">
            <div class="symbol symbol-40 bg-light mr-3">
              <div class="symbol-label">
                <span class="svg-icon svg-icon-md svg-icon-danger">
            ...
            <?php
            $countpengembalian = $db->table('keranjang')->where('status', 'Dikembalikan')->where('user_id', session('id2'))->countAllResults();
            ?>
            <div class="navi-text">
              <div class="font-weight-bold">Dikembalikan</div>
              <div class="text-muted">Pengembalian product <span class="label label-light-danger label-inline font-weight-bold"><?= $countpengembalian ?></span></div>
            </div>
          </div>
        </a>
        <!--end:Item-->
