  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Laporan Terkirim</h3>
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <form action="<?= BASE ?>/laporan/terkirim" method="POST" target="_blank">
          <div class="box-body">
...
<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Laporan Terkirim Periode</h3>
        <div class="card-tools">
          <!-- <a href="<?= BASE ?>/produk/" class="btn btn-warning">Back</a> -->
        </div>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <form action="<?= BASE ?>/laporan/terkirim_periode" method="POST" target="_blank">
          <div class="box-body">
            <div class="row clearfix">
              <div class="col-md-6">
