            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th class=" font-weight-bold text-muted text-uppercase">No Hp</th>
                  <th class=" font-weight-bold text-muted text-uppercase">Kota</th>

                </tr>
              </thead>
              <tbody>
                <?php
                $cart2 = $db->table('users')->select('users.*,tb_kota_kabupaten.*, biodata.*, users.nama as nama_user',false)->join('biodata', 'id_user=user_id')->join('tb_kota_kabupaten', 'tb_kota_kabupaten.id=kota_id')->where('role', 'Customer')->get()->getResult();
                $no = 1;
                ...
                ?>
                  <tr class="font-weight-boldest">
                    ...
                    <td class="pt-7 align-middle"><?= $row->nama_user ?></td>
