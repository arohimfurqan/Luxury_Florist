            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th class=" font-weight-bold text-muted text-uppercase">Jumlah</th>
              ...
              <tbody>
                ...
                ?>
                  <tr class="font-weight-boldest">
                    ...
                    <td class="pt-7 align-middle"><?= $row->tanggal_keluar ?></td>
                    <td class="pt-7 align-middle">Rp. <?= number_format($row->jumlah) ?></td>
                    <td class="pt-7 align-middle"><?= $row->keterangan ?></td>
                ...
                <tr>
                  <td colspan="2" class="font-weight-bolder font-size-h5 ">Total</td>
                  <!-- <td class=" font-weight-bolder font-size-h5 text-right">Total</td> -->
                  <td colspan="2" class=" font-weight-bolder font-size-h5 text-success  pr-0">Rp. <?= number_format(@$total) ?></td>
                </tr>
