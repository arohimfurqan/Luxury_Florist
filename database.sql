...
MySQL - 5.5.5-10.4.24-MariaDB : Database - luxury_florist
*********************************************************************
*/
...
insert  into `biodata`(`id_biodata`,`user_id`,`alamat`,`no_hp`,`provinsi_id`,`kota_id`) values (8,5,'cengkeh','79875687',13,1303),(9,11,'padang','968767',13,1371);
